		...
		\begin{packed_enum}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC8 - \text Definiranje spasilaca }}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - \text Otvaranje akcije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC10 - \text Završavanje akcije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - \text Uklanjanje spasioca s akcije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC12 - \text Odazivanje na akciju}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 - \text Zadavanje pojedinačnih zadataka}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC14 - \text Odabir moda izračuna dijagrama}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC17 -Pregled pozicije ostalih spasilaca}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 -Komentiranje}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 -Pregled komentara}}
					\begin{packed_item}
