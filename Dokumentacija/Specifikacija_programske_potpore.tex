	...
	\section{Funkcionalni zahtjevi}
		...
		\begin{packed_enum}
			...
			\subsection{Obrasci uporabe}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/usecase.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/dispatcher_sequence.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{UC10 Otvaranje akcije}
					\label{fig:promjene}
				\end{figure}
							\begin{figure}[H]
				\includegraphics[scale=0.5]{slike/Voditelj.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
				\caption{Prikaz postupka u kojem voditelj dodaje neraspoređene spasioce u svoju postaju i dodjeljuje im za što su osposobljeni}
				\label{fig:promjene}
				\end{figure}
				
				\begin{figure}[H]
					\includegraphics[scale=0.4]{slike/Akcija.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{Prikaz postupka dispečera i spasioca od početka do kraja akcije. Kada je spasiocu dodijeljena akcija, ili on stvara upit za prikaz karte i ostalih sudionika u akciji ili odbija dodijeljenu akciju. kada se spasioc vrati s akcije, dispečer ju zatvara i status spasioca se vraća na dostupan.}
					\label{fig:promjene}
				\end{figure}
